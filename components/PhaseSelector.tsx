      ...
      <div className="p-6 bg-white rounded-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input
                        ...
                        className="block w-full p-2 text-base border-2 border-slate-400 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 disabled:bg-slate-100"
                        required
                    />
                </div>
                <div>
            ...
            <div>
                <div className="flex justify-between items-center mb-1">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 text-sm font-semibold text-teal-600 hover:text-teal-800 disabled:text-slate-400"
                      disabled={!userApiKey}
                    >
                      Lihat Referensi CP
                ...
                <textarea
                    ...
                    className="block w-full p-2 text-base border-2 border-slate-400 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 scrollbar-none [&::-webkit-scrollbar]:hidden disabled:bg-slate-100"
                    required
                />
            ...
            <button
                ...
                className="flex items-center justify-center gap-2 bg-teal-600 text-white font-bold py-2 px-6 rounded-lg shadow-lg hover:bg-teal-700 hover:shadow-xl transition-all transform hover:-translate-y-0.5 disabled:bg-slate-400 disabled:shadow-none disabled:transform-none disabled:cursor-not-allowed"
