    ...
    <div className="mt-8">
      <Card>
        <div className="text-center">
            <BookOpenIcon className="mx-auto h-12 w-12 text-teal-500" />
        ...
        <div className="mt-8 border-t pt-6">
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                <div className="flex flex-col items-center">
                    <div className="flex items-center justify-center h-12 w-12 rounded-full bg-teal-100 text-teal-600 font-bold text-xl">1</div>
                ...
                <div className="flex flex-col items-center">
                    <div className="flex items-center justify-center h-12 w-12 rounded-full bg-teal-100 text-teal-600 font-bold text-xl">2</div>
                ...
                <div className="flex flex-col items-center">
                    <div className="flex items-center justify-center h-12 w-12 rounded-full bg-teal-100 text-teal-600 font-bold text-xl">3</div>
